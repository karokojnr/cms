...
app.use(session({
    ...
    store: new MongoStore({
      url: 'mongodb://karokojnr:<password>@cluster0-shard-00-00-ubthk.gcp.mongodb.net:27017,cluster0-shard-00-01-ubthk.gcp.mongodb.net:27017,cluster0-shard-00-02-ubthk.gcp.mongodb.net:27017/test?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin&retryWrites=true&w=majority',
      autoReconnect: true,
    })  
}));
app.use(flash());
